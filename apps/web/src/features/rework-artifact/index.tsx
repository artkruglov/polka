  ...
  return (
    <Dialog title="Переработать с помощью агента" onClose={onClose}>
      <div className="dialog-body">
        <p>
          Передайте материал своему агенту и опишите изменения. Сохраните
          результат новой версией — отправленная ссылка останется прежней.
        </p>
        <CopyText
          label="Текст запроса агенту"
          value={`Возьми мой материал «${title}» с Полки. Измени его: [опишите, что поменять]. Сохрани результат на Полке новой версией этого же материала.`}
        />
        <p className="fine">
