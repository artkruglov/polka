...
const VALUES: Array<{
  ...
  },
  {
    ...
    points: [
      ...
      <>
        Ссылки наружу и комментарии с полки отдела <InProgress />
      </>,
    ],
  },
  {
...
/**
 * What the first pilots shape, in the roadmap's order (docs/roadmap.md, «Что
 * осталось»): none of it is on main yet, and the page says so.
 */
const NEXT: Array<{ icon: React.ReactNode; title: string; points: string[] }> = [
  {
    ...
    points: [
      "Ссылки наружу и комментарии с полок отделов.",
      ...
      "Агент только к нужной папке или библиотеке и журнал его действий: что сохранил, изменил, кому открыл ссылку.",
    ],
  },
  {
    icon: <Plug />,
  ...
  {
    icon: <Server />,
    title: "Эксплуатация своей установки",
    points: [
      "Алерты о бэкапах, диске и ошибках.",
      "Проверенное восстановление на отдельной машине и инструкция обновления версий.",
