-- Operator-reviewed grants for the restore-only erasure reconciler at schema 042.
...
BEGIN
  ...
  IF current_schema()<>'public'
    ...
    RAISE EXCEPTION 'Restore grants require exactly migrations 001 through 042';
  END IF;
END $$;
...
ALTER DEFAULT PRIVILEGES FOR ROLE :"schema_owner" IN SCHEMA public
  REVOKE ALL PRIVILEGES ON SEQUENCES FROM PUBLIC, :"restore_role";
COMMIT;
\echo Restore worker grants installed for reviewed schema through migration 042
