-- Operator-reviewed grants for the isolated account purge worker at schema 048.
...
BEGIN
  ...
  IF current_schema()<>'public'
    ...
    RAISE EXCEPTION 'Purge grants require exactly migrations 001 through 048';
  END IF;
END $$;
...
ALTER DEFAULT PRIVILEGES FOR ROLE :"schema_owner" IN SCHEMA public
  REVOKE ALL PRIVILEGES ON SEQUENCES FROM PUBLIC, :"worker_role";
COMMIT;
\echo Purge worker grants installed for reviewed schema through migration 048
