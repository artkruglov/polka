-- Unlink retained account tombstones from template libraries during terminal purge.
-- Preserve other members and their source materials; archive only libraries losing their last active admin.
