...
- **Меню Export → Download**: пункты ищутся по `role="menuitem"` и тексту (Export/Экспорт, Download/Скачать), кнопка-название — как кнопка без aria-label рядом с Share. Переименование пунктов, другая локаль, меню, которое не открывается синтетическими событиями, или скачивание через сервер — и расширение перейдёт к фрейму (отрисованная копия). Меню на мгновение открывается у вас на глазах.
