...
Это локальная проверка. Hosted-приёмку после запуска на VM нужно записать отдельно (команды в [deploy/hosted/README.md](../../../deploy/hosted/README.md#редакционный-каталог-интересное)).
