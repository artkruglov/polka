...
[Локальная поставка](reviews/2026-09-21-self-host-base/README.md),
[удаление и восстановление](reviews/2026-09-21-account-purge/README.md).
...
tests. `maintenance-child.ts`/scheduler — независимый пакет Luna/root; они
...
Luna независимо: `apps/server/health.ts` с dependency-injected probe adapters,
...
Root/Sol отдельно: shared migration catalog + DB/S3 adapters/bootstrap smoke;
...
Регрессионные проверки разделены на maintenance-scheduler, maintenance-child, maintenance-log-filter, maintenance-guard и maintenance-gc. Упомянутый выше единый maintenance-runner.test.ts заменён этими focused файлами. [Доказательства](reviews/2026-09-21-self-host-base/README.md).
