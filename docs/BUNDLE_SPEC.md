...
## Принятый контракт интеграции (Astra)
...
Begin/put/finalize, status/abort, полный JSON export и cleanup реализованы и проверены локально. [Доказательства](reviews/2026-09-20-bundle-capture/REVIEW.md). Следующий шаг — воспроизводимое inline-производное для живого просмотра закреплённого bundle, затем importer/MCP. Хранение пакета не означает runtime-приёмку.
