...
20.09.2026. Implementation-ready UI contract для R04/R05; backend уже выдаёт scoped tokens. Не OAuth, не встроенный чат. Исполнитель Luna меняет только web UI/client и стили; backend, migrations, worker и MCP tools этого пакета не касаются.
