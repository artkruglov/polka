...
| M3 Агентский review через MCP | Внешний агент читает разрешённый контекст, предлагает candidate; человек принимает в Полке | Проверены scope/replay/cancel/needs_input и конфликт с ручной правкой; embedded chat и зеркалирование истории отсутствуют; каждый adapter принят отдельно |
...
7. P20/P13/P14 → внешний агент читает/правит candidate через MCP, получает owner-only адрес, а человек обсуждает и принимает изменение в интерфейсе Полки. Встроенный чат и зеркалирование истории не входят в релиз.
