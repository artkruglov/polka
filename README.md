...
Подробнее — на странице [«Для компаний»](https://polochka.app/enterprise) и в [COMMERCIAL.md](COMMERCIAL.md). SSO/SCIM и командных аккаунтов пока нет ([дорожная карта](docs/roadmap.md)).
...
> [!NOTE]
> **Prerelease.** Последний тег — `v0.1.0-rc.5`, изменения после него перечислены в [CHANGELOG](CHANGELOG.md). Hosted-пилот работает на https://polochka.app; регистрация по почте открыта, до 50 новых полок в сутки. API, схема БД и интерфейс ещё могут меняться.
