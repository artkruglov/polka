...
| Что есть | Всё открытое ядро | Всё открытое ядро: полки отделов, роли, агенты по полкам, администратор компании, вход через IdP | Ядро и расширение для организаций: ссылки только для сотрудников, политика ссылок; дальше — журнал агентов, интеграции, SAML и SCIM, установка без интернета |
