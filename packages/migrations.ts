...
const catalog = [
  ...
  { version: 35, file: "035_recipient_cta_events.sql" },
  { version: 36, file: "036_shelf_access.sql" },
  { version: 37, file: "037_url_import_rendering.sql" },
  { version: 38, file: "038_agent_folder_operations.sql" },
  ...
  { version: 43, file: "043_projects.sql" },
  { version: 44, file: "044_team_shelves_invariants.sql" },
  { version: 45, file: "045_agent_shelves.sql" },
